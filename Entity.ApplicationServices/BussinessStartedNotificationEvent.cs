...
{
    public class ProcessStartedNotificationEvent
    {
        public ProcessStartedNotificationEvent(string requestNumber, Author author, EntityPlaceRevocationInfo[] PlacesToRevoke)
        {
