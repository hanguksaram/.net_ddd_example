...
{
    public class ProcessCancelledNotificationEvent
    {
        public ProcessCancelledNotificationEvent(string requestNumber, Author author, EntityPlaceRevocationInfo[] PlacesToRevoke)
        {
